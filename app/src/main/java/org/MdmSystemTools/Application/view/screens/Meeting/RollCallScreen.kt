...
fun RollCallScreen(
  ...
  Scaffold(
    ...
    Column(modifier = Modifier.padding(padding).fillMaxSize().background(Color(0xFFF6F7FF))) {
...
fun StatusChip(text: String, color: Color) {
  Box(
    ...
    modifier =
      Modifier.background(color.copy(alpha = 0.15f), RoundedCornerShape(8.dp))
...
@Preview
@Composable
private fun RollCallPreview() {
  RollCallScreen(onBack = {}, onNavigateToStartGroup = {}, onViewHistoryItem = {})
}
